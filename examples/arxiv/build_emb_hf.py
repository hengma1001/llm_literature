...
umap_emb = run_umap(emb_df.embedding.to_list(), n_components=2, metric="euclidean")
emb_df["umapE_0"] = umap_emb[:, 0]
emb_df["umapE_1"] = umap_emb[:, 1]

umap_emb = run_umap(emb_df.embedding.to_list(), n_components=2, metric="cosine")
emb_df["umapC_0"] = umap_emb[:, 0]
emb_df["umapC_1"] = umap_emb[:, 1]
